...
def main():
    ...
    app_mode = st.sidebar.selectbox("Choose the app mode", ["Simplex Method", "Graphic Method","Two-Phase Method","Dual simplex Method"])
    ...
    elif app_mode == "Graphic Method":
        st.header("Graphic Method")
        st.header("Input Problem Type")
